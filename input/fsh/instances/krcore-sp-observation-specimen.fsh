Instance: krcore-sp-observation-specimen
...
* url = "http://www.hl7korea.or.kr/fhir/krcore/SearchParameter/krcore-sp-observation-specimen"
* version = "2.0.0"
* name = "KRCoreSearchParameterObservationSpecimen"
* derivedFrom = "http://hl7.org/fhir/SearchParameter/Observation-specimen"
* status = #active
* experimental = false
