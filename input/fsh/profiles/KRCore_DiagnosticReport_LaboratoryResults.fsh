...
* ^purpose = "**KR CDI V2 진단검사** 클래스에서 정의한 진단 관련 항목들과 주요 추가 정보를 구조화하기 위해 정의한 Profile."
* . ^short = "KR Core DiagnosticReport Profile for Laboratory Results"
* status MS
* status ^short = "진단검사 보고서 상태: registered | partial | preliminary | final +"
* status ^alias[0] = "KRCDI: 진단검사 상태"
...
* conclusion ^short = "진단검사 결과 판독 소견"
* conclusion ^alias[0] = "KRCDI: 결과 판독"
* conclusionCode ^short = "코드화된 진단검사 결과 판독 소견"
* conclusionCode ^alias[0] = "KRCDI: 결과 판독"